...
type IconName = "home" | "todos" | "notes" | "people" | "history" | "options" | "review" | "update" | "glow" | "contrast";
...
export function AppNavigation({ current }: { current?: AppPage }) {
  ...
  // The dock sits outside the header: the header's backdrop filter would
  // otherwise become the containing block for the dock's fixed position.
  return <>
