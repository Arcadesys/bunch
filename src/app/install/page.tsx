...
export default function InstallPage() {
  return <main className="app-page">
    ...
    <div className="app-page-body">
      ...
      <section className="panel"><h2>Ready for your first launch</h2><p>Tap the <strong>Bunch</strong> icon on your home screen. Sign in with your usual Google account if asked, then check that Catch-up and People open.</p><p>Bunch needs an internet connection. Installation does not make your records public.</p><Link className="button" href="/home/catch-up">Open Catch-up</Link></section>
    </div>
  </main>;
}
